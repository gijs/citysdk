...
#place[population>100000][population<250000][zoom>=8][zoom<=15] {
  text-name:'[name]';
  text-face-name:@sans;
  text-placement:point;
  text-fill:@city_text;
...
#place[population>50000][population<250000][zoom>=8][zoom<=15] {
  text-name:'[name]';
  text-face-name:@sans;
  text-placement:point;
  text-fill:@city_text;
...
#place[population>15000][population<250000][zoom>=8][zoom<=15] {
  text-name:'[name]';
  text-face-name:@sans;
  text-placement:point;
  text-fill:@city_text;
...
#place[type='town'][population>55000][zoom>=8][zoom<=15]
{
  text-name:'[name]';
  text-face-name:@sans;
  text-placement:point;
...
#area_label {
  ...
  [zoom>=10][area>0.00825147711], // 102400000
  [zoom>=11][area>0.00206286927], // 25600000
  [zoom>=13][area>0.00012892932], // 1600000
  [zoom>=14][area>0.00002578586], // 320000
  [zoom>=15][area>0.00000644646], // 80000
  [zoom>=16][area>0.00000161161], // 20000
  [zoom>=17][area>4.02904156e-7], // 5000
  [zoom>=18][area>=0] {
    text-name: "[name]";
  ...
  [zoom=15][area>0.00012892932],  // 1600000
  [zoom=16][area>0.00000644646],  // 80000
  [zoom=17][area>0.00000161161],  // 20000
  [zoom=18][area>4.02904156e-7] { // 5000
    text-name: "[name]";
    text-size: 13;
    text-wrap-width: 60;
    text-character-spacing: 1;
  ...
  [zoom=16][area>0.00012892932],  // 1600000
  [zoom=17][area>0.00000644646],  // 80000
  [zoom=18][area>0.00000161161] { // 20000
    text-size: 15;
    text-character-spacing: 2;
    text-wrap-width: 120;
  }
  [zoom>=17][area>0.00012892932],  // 1600000
  [zoom>=18][area>0.00000644646] { // 80000
    text-size: 20;
    text-character-spacing: 3;
    text-wrap-width: 180;
  }
...
#motorway_label[zoom>=11][zoom<=16][reflen<=8] {
  shield-name: "[ref]";
  shield-size: 9;
  shield-face-name: @sans_bold;
  shield-fill: @road_text; //#fff
  shield-file: url(img/shield-motorway-1.png);  
  [type='motorway'],[type='trunk'] {
    [reflen=1] { shield-file: url(img/shield-bw-1.png); }
    [reflen=2] { shield-file: url(img/shield-bw-2.png); }
    [reflen=3] { shield-file: url(img/shield-bw-3.png); }
    [reflen=4] { shield-file: url(img/shield-bw-4.png); }
    [reflen=5] { shield-file: url(img/shield-bw-5.png); }
    [reflen=6] { shield-file: url(img/shield-bw-6.png); }
    [reflen=7] { shield-file: url(img/shield-bw-7.png); }
    [reflen=8] { shield-file: url(img/shield-bw-8.png); }
  }  
  ...
  [zoom=16] { shield-min-distance: 180; }
}
